...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,205 | 🐛 75 | 📅 2026-03-09
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,351 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-10 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
* [Ant Design Web3](https://github.com/ant-design/ant-design-web3) ⭐ 1,127 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-09 - Efficient react components for building dapps easier | Connect crypto wallets and more Web3 UI components | Web3 icons | Supports Ethereum, Solana, Bitcoin, TON, Sui and others.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,149 | 🐛 824 | 🌐 TypeScript | 📅 2026-03-10 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,389 | 🐛 141 | 🌐 Vue | 📅 2026-03-05 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,516 | 🐛 208 | 🌐 C# | 📅 2026-03-09 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [react-lz-editor](https://github.com/leejaen/react-lz-editor) ⭐ 946 | 🐛 104 | 🌐 JavaScript | 📅 2022-12-06 - An open source rich react editor based on draft-Js and ant design.
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,232 | 🐛 453 | 🌐 JavaScript | 📅 2025-08-16 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
