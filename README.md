...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,818 | 🐛 76 | 📅 2026-03-09
...
* [Dva Cli](https://github.com/dvajs/dva-cli) ⭐ 965 | 🐛 67 | 🌐 JavaScript | 📅 2019-03-17 - Create Ant Design projects based on [Dva.js](https://github.com/dvajs/dva) ⭐ 16,204 | 🐛 28 | 🌐 JavaScript | 📅 2025-08-06, a
  lightweight front-end framework based on Redux and React and inspired by [Elm](http://elm-lang.org) and [Choo](https://github.com/yoshuawuyts/choo) ⭐ 6,772 | 🐛 44 | 🌐 JavaScript | 📅 2026-02-20.
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,361 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-10 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
* [Ant Design Web3](https://github.com/ant-design/ant-design-web3) ⭐ 1,127 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-10 - Efficient react components for building dapps easier | Connect crypto wallets and more Web3 UI components | Web3 icons | Supports Ethereum, Solana, Bitcoin, TON, Sui and others.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,149 | 🐛 821 | 🌐 TypeScript | 📅 2026-03-12 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,393 | 🐛 140 | 🌐 Vue | 📅 2026-03-05 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,514 | 🐛 200 | 🌐 C# | 📅 2026-03-11 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,239 | 🐛 453 | 🌐 JavaScript | 📅 2025-08-16 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [Antd Admin](https://github.com/zuiidea/antd-admin) ⭐ 9,798 | 🐛 32 | 🌐 JavaScript | 📅 2026-02-19 - A admin dashboard application demo built upon Ant Design and Dva.js.
...
* [syn-antd](https://gitlab.com/synqrinus/syn-antd) - Ant Design wrapper for [ClojureScript](https://clojurescript.org/) and [Reagent](https://github.com/reagent-project/reagent) ⭐ 4,862 | 🐛 26 | 🌐 Clojure | 📅 2026-01-23 using [shadow-cljs](http://shadow-cljs.org/) with tree-shaking support. As with other ClojureScript libraries, it cross-compiles to JavaScript.
...
Your contributions are always welcome! [Click Here to read the guidelines](https://github.com/websemantics/awesome-ant-design/blob/master/contributing.md) ⭐ 3,282 | 🐛 31 | 📅 2025-07-29.
