...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,096 | 🐛 77 | 📅 2026-03-09
...
* [Ant Design X](https://github.com/ant-design/x) ⭐ 4,367 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-13 - A React UI library @ant-design/x that Crafting AI-driven interfaces with React, seamlessly integrating smart chat components and API services at your fingertips.
...
* [NG-ZORRO](https://github.com/NG-ZORRO/ng-zorro-antd) ⭐ 9,150 | 🐛 821 | 🌐 TypeScript | 📅 2026-03-12 - Ant Design of Angular.
...
* [ant-design-vue](https://github.com/vueComponent/ant-design-vue) ⭐ 21,393 | 🐛 138 | 🌐 Vue | 📅 2026-03-13 - Ant Design of Vue.js 2.5.0+.
...
* [Blazorise](https://github.com/stsrki/Blazorise) ⭐ 3,514 | 🐛 203 | 🌐 C# | 📅 2026-03-12 - AntDesign support for Blazorise and Blazor [Demo](https://antdesigndemo.blazorise.com/)
...
* [IDURAR ERP/CRM](https://github.com/idurar/idurar-erp-crm) ⭐ 8,244 | 🐛 454 | 🌐 JavaScript | 📅 2025-08-16 - IDURAR is Open Source ERP/CRM (Invoice / Inventory / Accounting / HR) Based on Mern Stack (Node.js / Express.js / MongoDb / React.js ) with Ant Design (AntD) and Redux
...
* [syn-antd](https://gitlab.com/synqrinus/syn-antd) - Ant Design wrapper for [ClojureScript](https://clojurescript.org/) and [Reagent](https://github.com/reagent-project/reagent) ⭐ 4,863 | 🐛 26 | 🌐 Clojure | 📅 2026-01-23 using [shadow-cljs](http://shadow-cljs.org/) with tree-shaking support. As with other ClojureScript libraries, it cross-compiles to JavaScript.
